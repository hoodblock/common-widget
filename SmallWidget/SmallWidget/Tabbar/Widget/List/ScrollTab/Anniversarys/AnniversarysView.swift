...
struct AnniversarysView: View {
    ...
    let classSelf: [Any] = [
        AnniversarySnowMountainSmall.self, AnniversarySnowMountainMedium.self,
        AnniversaryEventsSmall.self, AnniversaryEventsMedium.self,
    ]
