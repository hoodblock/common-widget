...
struct RewardViewRepresentable: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> RewardViewController {
        return RewardViewController(objectSize, admobModel, showedBlock)
    }
...
class RewardViewController: UIViewController, FullScreenContentDelegate {
    var admobModel: FirebaseAdsItemModel = FirebaseAdsItemModel()
    var objectSize: CGSize = .zero
    var showedBlock: () -> Void  // 展示的回调
    ...
    private var rewardedAd: RewardedAd = RewardedAd()
    ...
    func loadRewardAd() {
        ...
        isRequesting = true
        print("【 \(CalendarTool.showCurrentTimeString(true)) 】_______【 Firebase 】_______【 Reward 】_______【 Request 】_______【 \(admobModel.ad_name) 】")
        admobModel.requestTime = CalendarTool.currentTimeInterval()
        RewardedAd.load(with: admobModel.ad_id, request: Request()) { [self] rewardedAd, err in
            if let err = err {
                print("【 \(CalendarTool.showCurrentTimeString(true)) 】_______【 Firebase 】_______【 Reward 】_______【 Request 】_______【 \(admobModel.ad_name) 】_______ 【 Failure __ \(err)】")
                return
            } else {
                ...
                print("【 \(CalendarTool.showCurrentTimeString(true)) 】_______【 Firebase 】_______【 Reward 】_______【 Request 】_______【 \(admobModel.ad_name) 】_______ 【 Success 】")
            }
            isRequesting = false
        }
    }
    ...
    func adDidDismissFullScreenContent(_ ad: FullScreenPresentingAd) {
        ...
        isRequesting = false
        print("【 \(CalendarTool.showCurrentTimeString(true)) 】_______【 Firebase 】_______【 Reward 】_______【 Show 】_______【 \(admobModel.ad_name) 】_______【 adDidDismissFullScreenContent 】")
...
//        _ = FirebaseNetwork.shared.loadRewardAdViewModel()
    ...
    func showRewardView() {
        if let currentRewardAd = admobModel.rewardedAd {
            ...
            print("【 \(CalendarTool.showCurrentTimeString(true)) 】_______【 Firebase 】_______【 Reward 】_______【 Show 】_______【 \(admobModel.ad_name) 】_______【 Reward Show Success 】")
        } else {
