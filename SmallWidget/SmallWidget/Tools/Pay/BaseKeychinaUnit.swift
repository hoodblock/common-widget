//
//  BaseKeychinaUnit.swift
//  SmallWidget
//
//  Created by 603 on 2024/8/12.
//

import UIKit


class BaseKeychinaUnit: NSObject {
    ...
    class func keyChainSaveData(data: Any ,withIdentifier identifier: String) -> Bool {
        ...
        // 设置数据
        keyChainSaveMutableDictionary.setValue(try! NSKeyedArchiver.archivedData(withRootObject: data, requiringSecureCoding: false), forKey: kSecValueData as String)
        // 进行存储数据
    ...
    class func keyChainUpdata(data: Any ,withIdentifier identifier: String) -> Bool {
        ...
        // 设置数据
        updataMutableDictionary.setValue(try! NSKeyedArchiver.archivedData(withRootObject: data, requiringSecureCoding: false), forKey: kSecValueData as String)
        // 更新数据
